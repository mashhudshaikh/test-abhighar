...
import { builderBySlug, typeKeyFor, slugKeyFor, type Property } from "@/lib/data";
...
export default function ProjectPageClient({ property: p, similar }: Props) {
  ...
  // every <LeadGate> on the page and every advisor form read/write the
  // same strings. See the previous file for the long-form explanation —
  // behavior unchanged.
  ...
  const parkingCount = (p.slug.charCodeAt(0) % 3) + 1;
